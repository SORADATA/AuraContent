<p align="center">
  <img src="assets/images/logo_auracontent.png" alt="AuraContent Logo" width="160" height="160" style="border-radius: 20px;">
</p>

# 🎬 AuraContent — Générateur & Publisher Automatisé de Vidéos "Faceless"

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=SORADATA-AuraContent&style=for-the-badge&color=blue" alt="Views">
</p>

**AuraContent** est un pipeline Python entièrement automatisé qui génère des vidéos "faceless" façon YouTube Shorts / TikTok à partir d'un simple sujet, et **les publie automatiquement sur TikTok**.
...
│   ├── images/                 # 🖼️ Logos et éléments visuels (logo_auracontent.png)
