...
class AssetManager:
    ...
    def get_videos(self, script_data, visual_identity=None):
        ...
        for scene in script_data:
            ...
            ok_a = self.generator.generate_image(
                scene["image_prompt"], path_a, visual_identity=visual_identity
            )
            ok_b = self.generator.generate_image(
                scene["image_prompt"], path_b, visual_identity=visual_identity
            )
